import{r as v,j as C,c as b}from"./index-B_XR-bXS.js";import{g as k,a as w,u as x,s as R,b as S,m as $,e as U,o as u,n as c}from"./createSimplePaletteValueFilter-BqFbd0Em.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return k("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return S({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
